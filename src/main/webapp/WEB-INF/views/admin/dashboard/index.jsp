...
<html lang="en" data-bs-theme="auto">
   <head>
      ...
      <script src="${SITE_URL}/static/js/color-modes.js"></script>
      <link href="${SITE_URL}/static/dist/css/bootstrap.min.css" rel="stylesheet">
      <meta name="theme-color" content="#712cf9">
      <link href="${SITE_URL}/static/css/dashboard.css" rel="stylesheet">
   ...
   <body>
      ...
      <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
         <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">DCMS</a> 
            ...
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
               <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                  <div class="offcanvas-header">
                     <h5 class="offcanvas-title" id="sidebarMenuLabel">DCMS</h5>
                  ...
                  <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                     <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                           <a class="nav-link d-flex align-items-center gap-2" href="${SITE_URL}/admin/doctors">
                              <svg class="bi" aria-hidden="true">
                        ...
                        <li class="nav-item">
                           <a class="nav-link d-flex align-items-center gap-2" href="${SITE_URL}/admin/patients">
                              <svg class="bi" aria-hidden="true">
                        ...
                        <li class="nav-item">
                           <a class="nav-link d-flex align-items-center gap-2" href="${SITE_URL}/admin/appointments">
                              <svg class="bi" aria-hidden="true">
                                 <use xlink:href="#file-earmark"></use>
                              </svg>
                              Appointments
